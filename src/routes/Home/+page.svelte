...
<!-- heroCover -->
<div class="mb-1"></div><section class="relative w-full overflow-hidden flex items-center justify-center min-h-screen" style="background-image:url('/site-assets/47-46725-prodovolstvennoe_zerno-nebo-pole-zakat-semeystvo_travy-192.jpg');background-size:cover;background-position:center;">
    ...
    <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <figure class="overflow-hidden rounded-xl border border-base-300 bg-base-100">
                <div class="h-40 bg-base-200">
                    <img class=" object-cover w-full h-full " src="/site-assets/52-pole_pshenitsa_derevia_976131_3840x2160.jpg" alt="/site-assets/52-pole_pshenitsa_derevia_976131_3840x2160.jpg" />
                </div>
